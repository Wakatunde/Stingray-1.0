...
bool stingray_msg__msg__stingray_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // up_down
    PyObject * field = PyObject_GetAttrString(_pymsg, "up_down");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->up_down = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // horizontal_rotation
  ...
  {  // light_toggle
    PyObject * field = PyObject_GetAttrString(_pymsg, "light_toggle");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->light_toggle = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // camera_angle
    ...
    assert(PyLong_Check(field));
    ros_message->camera_angle = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * stingray_msg__msg__stingray_control__convert_to_py(void * raw_ros_message)
{
  ...
  {  // up_down
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->up_down);
    {
      int rc = PyObject_SetAttrString(_pymessage, "up_down", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // light_toggle
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->light_toggle);
    {
      int rc = PyObject_SetAttrString(_pymessage, "light_toggle", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
