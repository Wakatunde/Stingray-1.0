  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: light_toggle
  {
    cdr << ros_message->light_toggle;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name up_down
  {
    size_t item_size = sizeof(ros_message->up_down);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name horizontal_rotation
  ...
  // field.name light_toggle
  {
    size_t item_size = sizeof(ros_message->light_toggle);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name camera_angle
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, camera_angle) +
      last_member_size
      ) == ret_val;
  }
